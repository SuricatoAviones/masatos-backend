...
exports.updateOrderById = exports.getOrdersByUserId = exports.getOrdersByClientId = exports.getOrders = exports.getOrderById = exports.filterOrderByDate = exports.deleteOrderById = exports.createOrder = void 0;
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          ...
          data = req.query;
          _context2.next = 5;
          return _Order["default"].find(data).populate("user").populate("table").populate("plates._id").populate("client");
        case 5:
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          ...
          _context3.next = 3;
          return _Order["default"].findById(orderId).populate("user").populate("table").populate("plates").populate("client");
        case 3:
...
var updateOrderById = exports.updateOrderById = /*#__PURE__*/function () {
...
var deleteOrderById = exports.deleteOrderById = /*#__PURE__*/function () {
...
var getOrdersByUserId = exports.getOrdersByUserId = /*#__PURE__*/function () {
  var _ref6 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6(req, res) {
    var userId, orders;
    return _regeneratorRuntime().wrap(function _callee6$(_context6) {
      while (1) switch (_context6.prev = _context6.next) {
        case 0:
          userId = req.params.userId; // Obtenemos el ID del usuario de los parámetros de la solicitud
          _context6.prev = 1;
          _context6.next = 4;
        ...
        case 4:
          ...
          // Buscamos todas las órdenes que pertenecen al usuario dado
  ...
  return function getOrdersByUserId(_x11, _x12) {
    return _ref6.apply(this, arguments);
  };
}();
var getOrdersByClientId = exports.getOrdersByClientId = /*#__PURE__*/function () {
  var _ref7 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee7(req, res) {
    var clientId, orders;
    return _regeneratorRuntime().wrap(function _callee7$(_context7) {
      while (1) switch (_context7.prev = _context7.next) {
        case 0:
          clientId = req.params.clientId; // Obtenemos el ID del usuario de los parámetros de la solicitud
          _context7.prev = 1;
          _context7.next = 4;
          return _Order["default"].find({
            user: clientId
  ...
  return function getOrdersByClientId(_x13, _x14) {
    return _ref7.apply(this, arguments);
  };
}();
var filterOrderByDate = exports.filterOrderByDate = /*#__PURE__*/function () {
  var _ref8 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee8(req, res) {
    var startDate, endDate, startDateDate, endDateDate, orders;
    return _regeneratorRuntime().wrap(function _callee8$(_context8) {
      while (1) switch (_context8.prev = _context8.next) {
        case 0:
          _context8.prev = 0;
          startDate = req.query.startDate;
          endDate = req.query.endDate; // Convertir las fechas a objetos Date
          startDateDate = new Date(startDate);
          endDateDate = new Date(endDate); // Validar que las fechas sean válidas
  ...
  return function filterOrderByDate(_x15, _x16) {
